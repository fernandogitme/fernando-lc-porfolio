                    ...
                    {dataAboutPage.map((data) => (
                        <div key={data.id} className="relative py-6 pl-8 sm:pl-36 group">
                            ...
                            <div className="flex flex-col sm:flex-row items-start mb-1 
                                ...
                                after:border-4 after:box-content after:border-secondary 
                                after:rounded-full sm:after:ml-[6.5rem] after:-translate-x-1/2 
                                after:translate-y-1.5">
                                <time className="sm:absolute sm:left-0 sm:-ml-10 sm:translate-y-0.5 inline-flex items-center justify-center text-xs font-semibold uppercase w-32 h-6 mb-3 sm:mb-0 text-gray-200 bg-gray-600 rounded-full order-1 sm:order-none self-center sm:self-auto mt-2 sm:mt-0 mx-auto sm:mx-0">                                
                                <em>{data.date}</em>
                            </time>
